...
public class Searcher {
	 ...
	 * @throws IOException
	 */
	public static List<OutputObject> searchImage(String args)
			throws IOException {
		...
		System.out.println("before reading lucene index");
		// IndexReader ir = DirectoryReader.open(FSDirectory.open(new
		// File("/home/ec2-user/index")));
		IndexReader ir = DirectoryReader.open(FSDirectory.open(new File(
				"C:\\Users\\Rahul\\Desktop\\LireBasedCloudProject\\index")));
