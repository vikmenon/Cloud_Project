...
public class S3Downloader {
    ...
    public String downloadImage(String fileName) throws IOException {
        ...
        String bucketName = "sincre-requests";
        // + UUID.randomUUID();
        //String key = fileName + UUID.randomUUID();
        ...
        try {
            ...
            saveFile(object.getObjectContent(),SERVER_UPLOAD_LOCATION_FOLDER + fileName);
            
            return SERVER_UPLOAD_LOCATION_FOLDER + fileName;
