...
public class SincreFileChooser_alone extends JPanel implements ActionListener {
    ...
    public SincreFileChooser_alone() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == browseButton) {
            int returnVal = fc.showOpenDialog(SincreFileChooser_alone.this);
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = SincreFileChooser_alone.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void GUI() {
        ...
        frame.add(new SincreFileChooser_alone(), BorderLayout.SOUTH);
