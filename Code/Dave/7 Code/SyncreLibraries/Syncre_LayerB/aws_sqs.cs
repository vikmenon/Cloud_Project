...
namespace Syncre_LayerB
{
    public static class aws_sqs
    {
        ...
        public static string ReceiveMessage(String queueUrl, ref List<Message> messages, ref string errMsg)
        {
            ...
            try
            {
                ...
                messageRecieptHandle = receiveMessageResponse.Messages[0].ReceiptHandle;
                errMsg = "";
            }
            catch (AmazonSQSException ex)
            {
