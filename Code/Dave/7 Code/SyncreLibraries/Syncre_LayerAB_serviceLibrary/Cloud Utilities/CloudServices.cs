...
namespace CloudServices
{
    ...
    public static class CloudServices
    {
        ...
        public static List<string> GetObject(ref List<string> data, ref string errMsg)
        {
            List<Amazon.SQS.Model.Message> messages = new List<Amazon.SQS.Model.Message>();
            List<string> transactionHandle = new List<string>();

            //get messages
            aws_sqs.ReceiveMessage(queue_w_b_url, ref messages, ref errMsg);
        ...
        public static void RemoveObject(List<string> objects, ref string errMsg)
        {
            foreach (string tranx in objects)
            {
                aws_sqs.DeleteMessage(queue_w_b_url, tranx, ref errMsg);
            }
        }
